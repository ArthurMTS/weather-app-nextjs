...
export function InfoCard({ title, value, sub, icon }: InfoCardProps) {
  return (
    <section className="flex justify-between items-center bg-whiter rounded-xl p-2 shadow w-32 h-20 sm:w-40 sm:h-24 md:w-44 md:h-32 xl:w-56 xl:p-2">
      ...
      <div className="flex flex-col items-end">
        ...
        <p className="font-semibold text-base sm:text-xl md:text-2xl xl:text-4xl">
          {value}
        </p>
